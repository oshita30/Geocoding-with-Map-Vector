...
TARGET_LENGTH = 15
ENCODING_MAP_1x1 = pickle.load(open(b"data/1x1_encode_map.pkl".'rb'))      # We need these maps
ENCODING_MAP_2x2 = pickle.load(open(b"data/2x2_encode_map.pkl",'rb'))      # and the reverse ones
REVERSE_MAP_1x1 = pickle.load(open(b"data/1x1_reverse_map.pkl",'rb'))      # to handle the used and
REVERSE_MAP_2x2 = pickle.load(open(b"data/2x2_reverse_map.pkl",'rb'))      # unused map_vector polygons.
OUTLIERS_MAP_1x1 = pickle.load(open(b"data/1x1_outliers_map.pkl",'rb'))    # Outliers are redundant polygons that
OUTLIERS_MAP_2x2 = pickle.load(open(b"data/2x2_outliers_map.pkl",'rb'))    # have been removed but must also be handled.
# -------- GLOBAL CONSTANTS AND VARIABLES -------- #
